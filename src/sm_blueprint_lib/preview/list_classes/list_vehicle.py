...
shapeset_json_path = os.path.join(GAME_DATA, "Objects", "Database", "ShapeSets", "vehicle.json")
print(shapeset_json_path)
survival_shapeset_json_path = os.path.join(SURVIVAL_DATA, "Objects", "Database", "ShapeSets", "vehicle.json")
