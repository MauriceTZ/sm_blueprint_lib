...
shapeset_json_path = os.path.join(GAME_DATA, "Objects", "Database", "ShapeSets", "spaceship.json")
print(shapeset_json_path)
survival_shapeset_json_path = os.path.join(SURVIVAL_DATA, "Objects", "Database", "ShapeSets", "spaceship.json")
...
all_parts = parts_json["partList"] + survival_parts_json["partList"]
# pp(all_decor)
