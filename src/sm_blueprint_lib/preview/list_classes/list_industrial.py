...
shapeset_json_path = os.path.join(GAME_DATA, "Objects", "Database", "ShapeSets", "industrial.json")
print(shapeset_json_path)
survival_shapeset_json_path = os.path.join(SURVIVAL_DATA, "Objects", "Database", "ShapeSets", "industrial.json")
...
all_parts = fittings_json["partList"] + survival_fittings_json["partList"]
# pp(all_decor)
