...
shapeset_json_path = os.path.join(GAME_DATA, "Objects", "Database", "ShapeSets", "interactive.json")
print(shapeset_json_path)
# survival_shapeset_json_path = os.path.join(SURVIVAL_DATA, "Objects", "Database", "ShapeSets", "interactive.json")
survival_shapeset_json_path = os.path.join(SURVIVAL_DATA, "Objects", "Database", "ShapeSets", "interactive_upgradeable.json")
...
with open(shapeset_json_path) as fp:
    parts_json = json.load(fp)
    # pp(decor_json)
...
all_parts = parts_json["partList"]
# all_parts = survival_fittings_json["partList"]
# pp(all_decor)
